...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    this.wsUri = 'ws://' + window.location.host + '/ws';
...
/**
 * Fired when the player seeks to a new location in the video
 * @event seeked
 */
...
vjs.Player.prototype.onWSOpen = function(evt) {
    //doSend("WebSocket rocks");
    console.log('Websocket opened');
    this.send('duration?');
};
vjs.Player.prototype.onWSClose = function(evt) {
    //writeToScreen("DISCONNECTED");
};
vjs.Player.prototype.onWSMessage = function(evt) {
    console.log('Received ws data: ' + evt.data);
    this.close();
};
vjs.Player.prototype.onWSError = function(evt) {
